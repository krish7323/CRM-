...
const navSections = [
  ...
  {
    category: 'RESOURCE & ERP MODULES',
    items: [
      {
        title: 'Digital Library',
        path: '/library',
        icon: <Library className="w-4 h-4 text-cyan-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Librarian', 'Teacher', 'Student'],
      },
      {
        title: 'Homework & Solutions',
        path: '/homework',
        icon: <BookMarked className="w-4 h-4 text-amber-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Teacher', 'Counsellor', 'Student'],
      },
      {
        title: 'Transport ERP',
        path: '/transport',
        icon: <Bus className="w-4 h-4 text-amber-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Transport Manager', 'Parent'],
      },
      {
        title: 'Inventory & Assets',
        path: '/inventory',
        icon: <Package className="w-4 h-4 text-teal-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Librarian'],
      },
      {
        title: 'Scholarships & Concessions',
        path: '/scholarships',
        icon: <HeartHandshake className="w-4 h-4 text-emerald-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Counsellor', 'Accountant'],
      },
      {
        title: 'Parent Teacher Meetings',
        path: '/ptm',
        icon: <Video className="w-4 h-4 text-purple-400" />,
        roles: ['Owner', 'Admin', 'Owner/Admin', 'Teacher', 'Counsellor', 'Parent'],
      },
      {
        title: 'Notice Board',
        path: '/notices',
      ...
      },
      {
        ...
        roles: ['Owner', 'Admin', 'Owner/Admin', 'HR', 'Teacher', 'Counsellor'],
      },
    ],
  },
  {
