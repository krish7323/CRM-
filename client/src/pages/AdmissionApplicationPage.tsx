...
import { Globe, GraduationCap, CheckCircle2, User, Phone, Mail, FileText, Bus, AlertCircle } from 'lucide-react';

export const AdmissionApplicationPage: React.FC = () => {
        ...
        {submitted ? (
          <div className="py-12 text-center space-y-4">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-amber-500 text-slate-950 font-bold text-xs hover:bg-amber-400"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2.5 text-slate-100 focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2.5 text-slate-100 focus:outline-none focus:border-amber-500 font-mono"
                />
              </div>
              ...
              <div>
                ...
                <select
                  value={form.busRequired}
                  onChange={(e) => setForm({ ...form, busRequired: e.target.value })}
                  className="w-full mt-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2.5 text-slate-100 focus:outline-none focus:border-amber-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, previousPercentage: e.target.value })}
                  placeholder="e.g. DPS Bengaluru - 88%"
                  className="w-full mt-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2.5 text-slate-100 focus:outline-none focus:border-amber-500"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-bold text-xs shadow-lg shadow-amber-500/20 hover:scale-[1.01] transition"
            >
