...
import { Award, QrCode, Download, Printer, CheckCircle2, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {selectedCert && (
          <div className="lg:col-span-2 glass-panel p-6 rounded-2xl border border-amber-500/30 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-500 text-slate-950 font-bold text-xs hover:bg-amber-400 transition"
              >
