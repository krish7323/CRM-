...
import { UserCheck, Sparkles, Plus, CheckCircle } from 'lucide-react';
      ...
      <div className="glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {eligibleLeads.map((lead) => (
            <div key={lead._id} className="glass-card p-4 rounded-xl border border-slate-800 space-y-3">
              ...
              <button
                onClick={() => convertLeadToStudent(lead._id)}
                className="w-full py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-teal-500 text-slate-950 font-bold text-xs hover:scale-105 transition flex items-center justify-center gap-1.5 shadow-md shadow-cyan-500/20"
              >
