...
import { MessageSquare, Send, CheckCheck, Sparkles, Smartphone } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-panel p-6 rounded-2xl border border-slate-800 flex flex-col md:flex-row items-center justify-around gap-6">
          <div className="w-full max-w-sm bg-slate-950 border-4 border-slate-800 rounded-[32px] p-4 shadow-2xl space-y-3 relative">
            ...
            <button
              onClick={() => alert(`Simulated WhatsApp message sent to ${testName}!`)}
              className="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-600/20 transition flex items-center justify-center gap-2"
            >
